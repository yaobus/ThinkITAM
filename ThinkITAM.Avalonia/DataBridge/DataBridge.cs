...
namespace ThinkITAM.DataBridge
{
    /// <summary>
    /// 跨页面全局状态静态类
    /// 替代 WPF MaterialDesign 的 DialogHost 和全局变量管理
    /// </summary>
    public class DataBridge
    {
        ...
        /// <summary>
        /// 从数据库读取的端口详细信息列表
        /// 注意：此处使用 dynamic 替代 WPF 的 PortDetailedInfo（含 Brush/PackIconKind）
        /// </summary>
        public static ObservableCollection<dynamic> PortDetailedInfos = new ObservableCollection<dynamic>();

        /// <summary>
        /// 新增设备端口页面查找后选择的设备信息
        /// </summary>
        public static AssetViewModel SelectAssetInfo = new AssetViewModel();
        ...
        /// <summary>
        /// 当前选择的端口模式，0为未分配，1为已分配未启用，2为已分配已启用，3为故障
        /// </summary>
