...
namespace ThinkITAM.ViewModels.NetworkManage
{
    public class IpAddressInfoListViewMode : INotifyPropertyChanged
    {
        ...
        private IBrush useStatusColor;
        private string pingTime;
        private IBrush pingStatusColor;
        private string user;
        private string name;
        ...
        private IBrush nowHostNameStatus;
        private string nowHostName;
        private IBrush nowMacAddressStatus;
        ...
        public IBrush NowHostNameStatus
        {
        ...
        public IBrush NowMacAddressStatus
        {
